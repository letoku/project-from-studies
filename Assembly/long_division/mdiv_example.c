...
static const test_data_t test_data[] = {
  // {1, (int64_t[2]){0, 0x8000000000000000},  -1, (int64_t[2]){0, 0x8000000000000000},  -1},  // test 0 
  {2, (int64_t[2]){0,  13}, -5, (int64_t[2]){0x6666666666666667, -3},  3},  // test 6 x
  {1, (int64_t[1]){ 13},  5, (int64_t[1]){ 2},  3},  // test 0 x
  {1, (int64_t[1]){-13},  5, (int64_t[1]){-2}, -3},  // test 1 x
  {1, (int64_t[1]){ 13}, -5, (int64_t[1]){-2},  3},  // test 2 x
  {1, (int64_t[1]){-13}, -5, (int64_t[1]){ 2}, -3},  // test 3 x
  {2, (int64_t[2]){0,  13},  5, (int64_t[2]){0x9999999999999999,  2},  3},  // test 4 x
  {2, (int64_t[2]){0, -13},  5, (int64_t[2]){0x6666666666666667, -3}, -3},  // test 5 x
  {2, (int64_t[2]){0,  13}, -5, (int64_t[2]){0x6666666666666667, -3},  3},  // test 6 x
  {2, (int64_t[2]){0, -13}, -5, (int64_t[2]){0x9999999999999999,  2}, -3},  // test 7 x
  {3, (int64_t[3]){1, 1, 1}, 2, (int64_t[3]){0x8000000000000000, 0x8000000000000000, 0},  1},  // test 8 x
};
